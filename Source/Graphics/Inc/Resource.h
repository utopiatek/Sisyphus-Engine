...
enum ESE_RESOURCE_FORMAT_ENUM
{
	...
	// 特殊纹理格式
	ESE_FORMAT_L8_UNORM = 0x1114,
	ESE_FORMAT_A8_UNORM = 0x2114,
	ESE_FORMAT_L8A8_UNORM = 0x3214,

	ESE_FORMAT_R5G6B5_UNORM = 0x4324,
	ESE_FORMAT_R5G5B5A1_UNORM = 0x5424,
	ESE_FORMAT_R4G4B4A4_UNORM = 0x6424,
	ESE_FORMAT_R10G10B10A2_UNORM = 0x7434,

	ESE_FORMAT_R11G11B10_FLOAT = 0x8331,
	ESE_FORMAT_R9G9B9E5_FLOAT = 0x9331,

	ESE_FORMAT_SR8G8B8_UNORM = 0xA314,
	ESE_FORMAT_SR8G8B8A8_UNORM = 0xB414,

	///////////////////////////////////////////////////////

	ESE_FORMAT_D32_FLOAT = 0xC131,
	ESE_FORMAT_D24_UNORM = 0xD104,
	ESE_FORMAT_D16_UNORM = 0xE124,
	ESE_FORMAT_D24_UNORM_S8_UINT = 0xF230,
