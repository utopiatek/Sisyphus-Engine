...
/// 拓扑图元类型。
/// </summary>
enum ESE_STATE_PRIMITIVE_TOPOLOGY_ENUM
{
	ESE_STATE_PRIMITIVE_TOPOLOGY_POINTLIST = 1,
	ESE_STATE_PRIMITIVE_TOPOLOGY_LINELIST = 2,
	ESE_STATE_PRIMITIVE_TOPOLOGY_LINESTRIP = 3,
	ESE_STATE_PRIMITIVE_TOPOLOGY_TRIANGLELIST = 4,
	ESE_STATE_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP = 5,
	ESE_STATE_PRIMITIVE_TOPOLOGY_TRIANGLELIST_ADJ = 12
};
