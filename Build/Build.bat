...
::X5只支持分配256内存
call emcc -O3 libCore.so libMath.so libGraphics.so libTest.so -s USE_WEBGL2=1 -s FULL_ES3=1 -s TOTAL_MEMORY=268435456 -s ASSERTIONS=1 -s WASM=1 -o index.html
